...
F22=False
F23=False
my_Fun=True ## 在benchmarks中的my_Fun函数里定义要求最优解的函数



optimizer=[PSO, MVO, GWO, MFO, CS, BAT, WOA, FFA]
benchmarkfunc=[F1,F2,F3,F4,F5,F6,F7,F8,F9,F10,F11,F12,F13,F14,F15,F16,F17,F18,F19,F20,F21,F22,F23,my_Fun]
...
series= pd.read_csv(ExportToFile).T
sns.pointplot(data=series["Iter1":].T,markers='.',)
